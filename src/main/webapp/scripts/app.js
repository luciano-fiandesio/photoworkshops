...
var photoworkshopsApp = angular.module('photoworkshopsApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'photoworkshopsAppUtils', 'pascalprecht.translate', 'truncate']);
